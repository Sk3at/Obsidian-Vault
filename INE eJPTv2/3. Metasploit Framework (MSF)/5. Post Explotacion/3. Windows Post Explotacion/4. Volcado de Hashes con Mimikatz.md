Mimikatz es una herramienta utilizada en la fase de post-explotacion para la extraccion de credenciales de la memoria en texto plano, hasehs de contraseñas de las base de datos SAM y mas.
