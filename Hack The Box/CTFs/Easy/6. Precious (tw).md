Luego de un escaneo inicial con nmap para revelar los puertos abiertos, realizamos un segundo escaneo para revelar los servicios en ejecucion en los puertos para asi descubrir un SSH y un servidor Web.
